                    ...
                    <div class="flex items-center bg-white px-4 pb-4">
                        <div>
                            <div class="my-4">
                                <label
                                    for="image"
                                    class="flex items-center justify-center bg-[#E7F3FF] hover:bg-[#DBE7F2] font-bold p-2 rounded-full text-[#1977F2] w-full cursor-pointer"
                                >
                            ...
                            <div class="flex gap-4" :class="uploadedImage ? 'pt-4' : ''">
                                <button
                                    @click="$emit('showModal', false)"
                                    type="button"
                                    class="w-full justify-center rounded-md py-2 text-gray-600 hover:text-gray-800 font-bold hover:shadow-sm hover:bg-gray-200 focus:outline-none focus:right-0"
                                >
                                    Cancel
                                </button>
                                <button
                                    ...
                                    @click="crop"
                                    type="button"
                                    class="w-full rounded-md bg-blue-500 py-2 text-white font-bold shadow-sm hover:bg-blue-600 focus:outline-none focus:right-0"
                                >
                                    Crop Image
                                </button>
                            </div>
