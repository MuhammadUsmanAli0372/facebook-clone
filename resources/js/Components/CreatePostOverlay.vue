                ...
                <div class="border-t border-t-gray-300">
                    <div class="p-4">
                        <div class="flex items-center">
                            <img class="rounded-full ml-1 min-w-[45px] max-h-[45px]" :src="user.image" alt="">
                            <div class="ml-4">
                        ...
                        <div class="max-h-[350px] overflow-auto">
                            <textarea
                                v-model="form.text"
                                class="w-full border-0 mt-4 focus:right-0 text-[22px]"
                        ...
                        <!-- Error Section -->
                        <div v-if="error">
                            <div class="w-full bg-red-100 text-red-200 rounded-lg mt-3 text-center">
                                <div class="p-0.5">
                                    {{ error }}
                                </div>
                            </div>
