...
<template>
    ...
    <MainNavLayout>
        <div class="fixed w-full h-[100%] bg-[#F1F2F5]">
            <div class="grid grid-cols-3 grid-flow-col w-full max-w-[1600px] mt-[56px] h-[calc(100%-56px)] mx-auto px-4">
                <div id="LeftSection" class="xl:w-[345px] lg:block hidden">
                    <div class="pt-4 max-w-[320px] pr-4">
                        ...
                        >
                            <img class="rounded-full ml-1 min-w-[38px] max-h-[38px]" :src="user.image" alt="">
                    ...
                    <div class="max-w-[340px] min-w-[250px] mx-auto pt-4">
                        ...
                        <div class="h-[calc(100vh-115px)] overflow-auto pt-2">
                            <div class="flex items-center justify-start cursor-pointer hover:bg-[#E5E6E9] py-2 rounded-md">
                                <img class="rounded-full ml-1 min-w-[38px] max-h-[38px]" src="https://picsum.photos/id/140/300/320" alt="">
                                <div class="text-[15px] text-gray-800 font-extrabold pl-3">Bilal Bhatti</div> 
                            </div>
                            <div class="flex items-center justify-start cursor-pointer hover:bg-[#E5E6E9] py-2 rounded-md">
                                <img class="rounded-full ml-1 min-w-[38px] max-h-[38px]" src="https://picsum.photos/id/145/300/320" alt="">
                                <div class="text-[15px] text-gray-800 font-extrabold pl-3">Umer</div> 
                            </div>
                            <div class="flex items-center justify-start cursor-pointer hover:bg-[#E5E6E9] py-2 rounded-md">
                                <img class="rounded-full ml-1 min-w-[38px] max-h-[38px]" src="https://picsum.photos/id/15/300/320" alt="">
                                <div class="text-[15px] text-gray-800 font-extrabold pl-3">Bhatti</div> 
                            </div>
                            <div class="flex items-center justify-start cursor-pointer hover:bg-[#E5E6E9] py-2 rounded-md">
                                <img class="rounded-full ml-1 min-w-[38px] max-h-[38px]" src="https://picsum.photos/id/122/300/320" alt="">
                                <div class="text-[15px] text-gray-800 font-extrabold pl-3">Mani</div> 
                            </div>
                            <div class="flex items-center justify-start cursor-pointer hover:bg-[#E5E6E9] py-2 rounded-md">
                                <img class="rounded-full ml-1 min-w-[38px] max-h-[38px]" src="https://picsum.photos/id/123/300/320" alt="">
                                <div class="text-[15px] text-gray-800 font-extrabold pl-3">Usman</div> 
                            </div>
                            <div class="flex items-center justify-start cursor-pointer hover:bg-[#E5E6E9] py-2 rounded-md">
                                <img class="rounded-full ml-1 min-w-[38px] max-h-[38px]" src="https://picsum.photos/id/200/300/320" alt="">
                                <div class="text-[15px] text-gray-800 font-extrabold pl-3">John Smith</div> 
                            </div>
                            <div class="flex items-center justify-start cursor-pointer hover:bg-[#E5E6E9] py-2 rounded-md">
                                <img class="rounded-full ml-1 min-w-[38px] max-h-[38px]" src="https://picsum.photos/id/140/300/320" alt="">
                                <div class="text-[15px] text-gray-800 font-extrabold pl-3">Bilal Bhatti</div> 
